...
export class Convert {
    public static toRestCountryResponse(json: string): Country[] {
        return cast(JSON.parse(json), a(r("RestCountryResponse")));
    }

    public static restCountryResponseToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("RestCountryResponse"))), null, 2);
    }
}
